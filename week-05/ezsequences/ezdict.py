ez_dict = {'birthdate': '1946-06-14', 'party': 'Republican', 'gender': 'M',
           'identifiers': {'twitter': 'realDonaldTrump', 'fec': 'P80001571'},
           'name': {'first': 'Donald', 'last': 'Trump'},
           'birthplace': {'state': 'NY', 'city': 'New York City'},
           'children': ['Donald', 'Ivanka', 'Eric', 'Tiffany', 'Barron'],
           'spouse': 'Melania Trump',
           'terms': [{'start_date': '2017-01-20', 'end_date': '2021-01-20'}]}
...
def foo_f():
    ...
    """
    return ez_dict['children'][(foo_e() - 1)]
...
def foo_g():
    ...
    Hint: Think about how you can create a new list by
      ...
      method.
    """
    final_string = ez_dict['spouse']

    for child in ez_dict['children']:
        final_string = final_string + "," + child
...
def foo_h():
    ...
    #Added return statement to avoid error
